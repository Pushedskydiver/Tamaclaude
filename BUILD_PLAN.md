...
- [x] Animations, in priority order — ship each as it lands:
  ...
  11. ✅ board game (`Agent`) — 0.7%, the least-seen of the screens that
      ...
      about the whole catalogue. Art landed 25 Aug and the
      `TOOL_ANIMATIONS` entry followed it the same day, which is this list's own
      "art first, wiring last" rule followed rather than broken. The trigger was
