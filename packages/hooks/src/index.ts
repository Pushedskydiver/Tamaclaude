 ...
 * preference. It reads an event from stdin, forwards it to the daemon over a
 * Unix socket, and exits. It does not render, load packs, or reason about
 * sessions — and it exports nothing, because it is a program.
 */
